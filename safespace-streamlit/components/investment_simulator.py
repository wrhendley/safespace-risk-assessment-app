...
def portfolio_simulator(token):
    ...
    # Form to fill out Investment Simulation Data
    ...
    start_date = st.date_input("Select Start Date", min_value=pd.to_datetime('1975-01-01'))
    ...
    # Must select allocation for each Ticker chosen
    allocations = {}
    ...
    # Button to simulate investment portfolio
    ...
    if submit_button:
        ...
        # Make ticker data calculations and append to overall portfolio
        portfolio_returns = []
        weighted_returns = []
        ...
        for ticker in selected_tickers:
            ...
            # Ticker performance calculations
            ...
            # Save Ticker Details for Later Display
        ...
        if portfolio_returns:
            ...
            # Make Portfolio Risk Calculations
